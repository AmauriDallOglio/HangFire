...
namespace HangFire.Api.Middleware
{
    ...
    public class HangFireJobs
    {
        ...
        public static void InserirUsuarioCada15Minutos()
        {
          
            RecurringJob.AddOrUpdate<HangFireServico>(
                "Tarefa-Inserir-Usuarios-Cada15Minutos",  // Nome do job
                service => service.TarefaInserirCincoUsuarios(), // Método da instância
                "*/15 * * * *",                           // Frequência: a cada 15 minutos
                TimeZoneInfo.Local            // Fuso horário local
            );
        }
        ...
        public static DateTimeOffset Minuto1()
        {
            var schudeleDateTime = DateTime.Now.AddMinutes(1);
            var datetimeoffSet = new DateTimeOffset(schudeleDateTime);
            return datetimeoffSet;
        }
